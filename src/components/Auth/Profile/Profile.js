    ...
    update(
      dbUserRef,
      {
        userImageURL:
          ...
          storageRef.bucket +
          "/o/" +
          encodeURIComponent(storageRef.fullPath) +
          "?alt=media",
        ...
        {user && (
          <div className="row">
            <div className="profile__hi">
              ...
              <span>
                Hello, have a good day! <b>{user.userName}</b>
              </span>
            </div>
            <div className="col col-3 profile__left">
              <div className="profile__info">
                <div className="profile__avt">
                  <img
                    src={
                      user.userImageURL || previewImage
                        ? previewImage || user.userImageURL
                        : DefaultAvt
                    }
                    alt="avatar"
                  />
                  <label className="btn btn-primary" htmlFor="inputImg">
                    Change avatar
                  </label>
                  <input
                    type="file"
