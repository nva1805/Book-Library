...
const Home = () => {
  ...
  return (
    <div
      ...
      style={{ color: textColor, textShadow: `0px 0px 10px ${boxShadowColor}` }}
    >
      <div>
      ...
      <div className="container homepage-soloGan d-flex flex-column">
        <h4>Enjoy life with your book, turn your life into a library!</h4>
        <p>
          One can gain admittance to different classifications of books and
          different assets in the library. It avoids the need to purchase costly
          books and assets. Let the book connect to your inner self.
        </p>
